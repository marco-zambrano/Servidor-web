...
export class DashboardService {
  ...
  async getFuncionDashboard(idFuncion: string) {
    try {
      ...
      throw new HttpException('Error al obtener el dashboard de la función', HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  async getUsuarioReporteCompleto(idUsuario: string, limite: number = 5) {
    try {
      ...
      throw new HttpException('Error al obtener el reporte del usuario', HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  async getPeliculaRendimiento(idPelicula: string) {
    try {
      ...
      throw new HttpException('Error al obtener el rendimiento de la película', HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
}